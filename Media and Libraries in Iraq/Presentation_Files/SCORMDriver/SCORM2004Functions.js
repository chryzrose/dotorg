...
function SCORM2004_SetSlideStarted(intSlideID){

    WriteToDebug("In SCORM2004_SetSlideStarted, --ignored--");
    return null;
}
...
function SCORM2004_DisplayMessageOnTimeout(){
    ...
    if (strTLA == SCORM_TLA_EXIT_MESSAGE || strTLA == SCORM_TLA_CONTINUE_MESSAGE){
        ...
        SCORM_SetErrorInfoManually(SCORM2004_ERROR_INVALID_TIME_LIMIT_ACTION, 
...
function SCORM2004_GetPassingScore(){
    ...
    if ( ! IsValidDecimal(fltScore)){
        ...
        SCORM_SetErrorInfoManually(SCORM2004_ERROR_INVALID_DECIMAL, 
...
function SCORM2004_GetEntryMode(){
    ...
    if (strEntry == SCORM2004_ENTRY_ABINITIO){
        ...
        SCORM_SetErrorInfoManually(SCORM2004_ERROR_INVALID_ENTRY, 
...
function SCORM2004_GetLessonMode(){
    ...
    if (strLessonMode == SCORM2004_BROWSE){
        ...
        SCORM_SetErrorInfoManually(SCORM2004_ERROR_INVALID_LESSON_MODE, 
...
function SCORM2004_GetTakingForCredit(){
    ...
    if (strCredit == "credit"){
        ...
        SCORM_SetErrorInfoManually(SCORM2004_ERROR_INVALID_CREDIT, 
...
function SCORM2004_SetObjectiveScore(strObjectiveID, intScore, intMaxScore, intMinScore){
    ...
    WriteToDebug("In SCORM2004_SetObjectiveScore, strObjectiveID=" + strObjectiveID + ", intScore=" + intScore + ", intMaxScore=" + intMaxScore + ", intMinScore=" + intMinScore);
...
function SCORM2004_GetObjectiveScore(strObjectiveID){
    ...
    WriteToDebug("In SCORM2004_GetObjectiveScore, strObjectiveID=" + strObjectiveID);
...
function SCORM2004_GetObjectiveStatus(strObjectiveID){
    ...
    WriteToDebug("In SCORM2004_GetObjectiveStatus, strObjectiveID=" + strObjectiveID);
    ...
    if (strSuccessStatus == SCORM2004_PASSED){
        ...
        SCORM_SetErrorInfoManually(SCORM2004_ERROR_INVALID_STATUS, 
...
function SCORM2004_ClearErrorInfo(){
    ...
    intSCORM2004Error = SCORM_NO_ERROR;
